        ...
        <form class="w-full max-w-md mx-auto" method="POST">
            ...
            <div class="relative">
                ...
                <input type="email" id="default-email"
                    ...
                    placeholder="Enter your email here..." required name="email" value="<?php echo $email; ?>" />
                <button type="submit"
                    class="text-white absolute right-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Inscription</button>
            </div>
        </form>
    </div>
</section>
